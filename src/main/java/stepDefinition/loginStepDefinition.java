 ...
 * Thread.sleep(10000); System.out.println(title); }
 * 
 * @Then("^user enters \"(.*)\" and \"(.*)\"$") public void
 * enter_login_credentials(String username, String password) {
 ...
 * 
 * 
 * @Then("^user click on Contact option from options$") public void
 * click_on_Contact_Option() throws InterruptedException {
 ...
 * 
 * 
 * @Then("^user click on New button to create contact$") public void
 * click_on_new_button_to_create_new_contact() throws InterruptedException {
 ...
 * Thread.sleep(5000); }
 * 
 * @Then("^user enters details \"(.*)\" and \"(.*)\"$") public void
 * enter_new_contact_details(String firstname, String lastname) throws
 * InterruptedException { Boolean present =
 ...
 * public void enter_new_deals_details(String title, String probability, String
 * commission) throws InterruptedException {
 * 
 * 
